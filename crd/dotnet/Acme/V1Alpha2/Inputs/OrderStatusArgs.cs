...
namespace Pulumi.Kubernetes.Types.Inputs.Acme.V1Alpha2
{
    ...
    public class OrderStatusArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Pulumi.Kubernetes.Types.Inputs.Acme.V1Alpha2.OrderStatusAuthorizationsArgs>? _authorizations;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Acme.V1Alpha2.OrderStatusAuthorizationsArgs> Authorizations
        {
            get => _authorizations ?? (_authorizations = new InputList<Pulumi.Kubernetes.Types.Inputs.Acme.V1Alpha2.OrderStatusAuthorizationsArgs>());
