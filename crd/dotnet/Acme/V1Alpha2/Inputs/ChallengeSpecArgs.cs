...
namespace Pulumi.Kubernetes.Types.Inputs.Acme.V1Alpha2
{
    ...
    public class ChallengeSpecArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("authzURL", required: true)]
        public Input<string> AuthzURL { get; set; } = null!;
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Acme.V1Alpha2.ChallengeSpecIssuerRefArgs> IssuerRef { get; set; } = null!;
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Acme.V1Alpha2.ChallengeSpecSolverArgs> Solver { get; set; } = null!;
