...
namespace Pulumi.Kubernetes.Types.Inputs.Acme.V1Alpha2
{
    ...
    {
        [Input("challenges")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Acme.V1Alpha2.OrderStatusAuthorizationsChallengesArgs>? _challenges;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Acme.V1Alpha2.OrderStatusAuthorizationsChallengesArgs> Challenges
        {
            get => _challenges ?? (_challenges = new InputList<Pulumi.Kubernetes.Types.Inputs.Acme.V1Alpha2.OrderStatusAuthorizationsChallengesArgs>());
