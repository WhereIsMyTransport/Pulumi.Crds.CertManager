...
namespace Pulumi.Kubernetes.Types.Inputs.Acme.V1Beta1
{
    ...
    public class OrderStatusArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Pulumi.Kubernetes.Types.Inputs.Acme.V1Beta1.OrderStatusAuthorizationsArgs>? _authorizations;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Acme.V1Beta1.OrderStatusAuthorizationsArgs> Authorizations
        {
            get => _authorizations ?? (_authorizations = new InputList<Pulumi.Kubernetes.Types.Inputs.Acme.V1Beta1.OrderStatusAuthorizationsArgs>());
