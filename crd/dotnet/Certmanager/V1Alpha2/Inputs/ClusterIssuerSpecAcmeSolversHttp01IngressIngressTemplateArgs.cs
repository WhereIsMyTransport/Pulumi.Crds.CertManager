...
namespace Pulumi.Kubernetes.Types.Inputs.Certmanager.V1Alpha2
{
    ...
    public class ClusterIssuerSpecAcmeSolversHttp01IngressIngressTemplateArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("metadata")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Certmanager.V1Alpha2.ClusterIssuerSpecAcmeSolversHttp01IngressIngressTemplateMetadataArgs>? Metadata { get; set; }
