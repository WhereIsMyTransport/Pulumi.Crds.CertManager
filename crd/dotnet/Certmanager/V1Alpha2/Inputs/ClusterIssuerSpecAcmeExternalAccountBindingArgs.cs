...
namespace Pulumi.Kubernetes.Types.Inputs.Certmanager.V1Alpha2
{
    ...
    public class ClusterIssuerSpecAcmeExternalAccountBindingArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Certmanager.V1Alpha2.ClusterIssuerSpecAcmeExternalAccountBindingKeySecretRefArgs> KeySecretRef { get; set; } = null!;
