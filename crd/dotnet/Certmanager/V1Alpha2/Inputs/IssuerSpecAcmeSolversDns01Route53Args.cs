...
namespace Pulumi.Kubernetes.Types.Inputs.Certmanager.V1Alpha2
{
    ...
    public class IssuerSpecAcmeSolversDns01Route53Args : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Certmanager.V1Alpha2.IssuerSpecAcmeSolversDns01Route53SecretAccessKeySecretRefArgs>? SecretAccessKeySecretRef { get; set; }
