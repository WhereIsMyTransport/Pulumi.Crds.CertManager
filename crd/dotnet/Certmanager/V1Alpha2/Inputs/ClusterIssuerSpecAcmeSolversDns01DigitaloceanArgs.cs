...
namespace Pulumi.Kubernetes.Types.Inputs.Certmanager.V1Alpha2
{
    ...
    public class ClusterIssuerSpecAcmeSolversDns01DigitaloceanArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Certmanager.V1Alpha2.ClusterIssuerSpecAcmeSolversDns01DigitaloceanTokenSecretRefArgs> TokenSecretRef { get; set; } = null!;
