...
namespace Pulumi.Kubernetes.Types.Inputs.Certmanager.V1Alpha2
{
    ...
    public class ClusterIssuerSpecAcmeSolversDns01AcmednsArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Certmanager.V1Alpha2.ClusterIssuerSpecAcmeSolversDns01AcmednsAccountSecretRefArgs> AccountSecretRef { get; set; } = null!;
