...
namespace Pulumi.Kubernetes.Types.Inputs.Certmanager.V1Alpha2
{
    ...
    {
        [Input("conditions")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Certmanager.V1Alpha2.CertificateStatusConditionsArgs>? _conditions;

        /// <summary>
        /// List of status conditions to indicate the status of certificates. Known condition types are `Ready` and `Issuing`.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Certmanager.V1Alpha2.CertificateStatusConditionsArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Pulumi.Kubernetes.Types.Inputs.Certmanager.V1Alpha2.CertificateStatusConditionsArgs>());
