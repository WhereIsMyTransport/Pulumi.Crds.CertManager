...
namespace Pulumi.Kubernetes.Types.Outputs.Certmanager.V1Alpha2
{
    ...
    public sealed class CertificateSpecKeystoresJks
    {
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Certmanager.V1Alpha2.CertificateSpecKeystoresJksPasswordSecretRef PasswordSecretRef;

        [OutputConstructor]
        private CertificateSpecKeystoresJks(
            bool create,

            Pulumi.Kubernetes.Types.Outputs.Certmanager.V1Alpha2.CertificateSpecKeystoresJksPasswordSecretRef passwordSecretRef)
        {
            Create = create;
