...
namespace Pulumi.Kubernetes.Types.Inputs.Certmanager.V1Beta1
{
    ...
    public class CertificateRequestStatusArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("conditions")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Certmanager.V1Beta1.CertificateRequestStatusConditionsArgs>? _conditions;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Certmanager.V1Beta1.CertificateRequestStatusConditionsArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Pulumi.Kubernetes.Types.Inputs.Certmanager.V1Beta1.CertificateRequestStatusConditionsArgs>());
