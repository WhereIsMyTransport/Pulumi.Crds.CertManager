...
namespace Pulumi.Kubernetes.Types.Inputs.Certmanager.V1Beta1
{
    ...
    public class IssuerSpecAcmeSolversDns01Route53Args : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Certmanager.V1Beta1.IssuerSpecAcmeSolversDns01Route53SecretAccessKeySecretRefArgs>? SecretAccessKeySecretRef { get; set; }
