...
namespace Pulumi.Kubernetes.Types.Inputs.Certmanager.V1Beta1
{
    ...
    public class ClusterIssuerSpecAcmeSolversDns01DigitaloceanArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Certmanager.V1Beta1.ClusterIssuerSpecAcmeSolversDns01DigitaloceanTokenSecretRefArgs> TokenSecretRef { get; set; } = null!;
