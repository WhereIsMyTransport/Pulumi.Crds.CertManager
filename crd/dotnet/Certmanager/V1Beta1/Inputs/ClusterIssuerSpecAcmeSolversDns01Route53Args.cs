...
namespace Pulumi.Kubernetes.Types.Inputs.Certmanager.V1Beta1
{
    ...
    public class ClusterIssuerSpecAcmeSolversDns01Route53Args : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Certmanager.V1Beta1.ClusterIssuerSpecAcmeSolversDns01Route53SecretAccessKeySecretRefArgs>? SecretAccessKeySecretRef { get; set; }
