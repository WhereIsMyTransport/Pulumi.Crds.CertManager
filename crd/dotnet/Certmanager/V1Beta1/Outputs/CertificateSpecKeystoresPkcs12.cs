...
namespace Pulumi.Kubernetes.Types.Outputs.Certmanager.V1Beta1
{
    ...
    public sealed class CertificateSpecKeystoresPkcs12
    {
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Certmanager.V1Beta1.CertificateSpecKeystoresPkcs12PasswordSecretRef PasswordSecretRef;

        [OutputConstructor]
        private CertificateSpecKeystoresPkcs12(
            bool create,

            Pulumi.Kubernetes.Types.Outputs.Certmanager.V1Beta1.CertificateSpecKeystoresPkcs12PasswordSecretRef passwordSecretRef)
        {
            Create = create;
