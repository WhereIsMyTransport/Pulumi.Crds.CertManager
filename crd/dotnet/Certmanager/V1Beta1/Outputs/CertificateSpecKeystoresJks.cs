...
namespace Pulumi.Kubernetes.Types.Outputs.Certmanager.V1Beta1
{
    ...
    public sealed class CertificateSpecKeystoresJks
    {
        ...
        /// </summary>
        public readonly Pulumi.Kubernetes.Types.Outputs.Certmanager.V1Beta1.CertificateSpecKeystoresJksPasswordSecretRef PasswordSecretRef;

        [OutputConstructor]
        private CertificateSpecKeystoresJks(
            bool create,

            Pulumi.Kubernetes.Types.Outputs.Certmanager.V1Beta1.CertificateSpecKeystoresJksPasswordSecretRef passwordSecretRef)
        {
            Create = create;
