...
namespace Pulumi.Kubernetes.Types.Inputs.Certmanager.V1Alpha3
{
    ...
    public class ClusterIssuerSpecAcmeSolversHttp01IngressArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Certmanager.V1Alpha3.ClusterIssuerSpecAcmeSolversHttp01IngressIngressTemplateArgs>? IngressTemplate { get; set; }
        ...
        /// </summary>
        [Input("podTemplate")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Certmanager.V1Alpha3.ClusterIssuerSpecAcmeSolversHttp01IngressPodTemplateArgs>? PodTemplate { get; set; }
