...
namespace Pulumi.Kubernetes.Types.Inputs.Certmanager.V1Alpha3
{
    ...
    public class ClusterIssuerSpecAcmeSolversHttp01IngressIngressTemplateArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("metadata")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Certmanager.V1Alpha3.ClusterIssuerSpecAcmeSolversHttp01IngressIngressTemplateMetadataArgs>? Metadata { get; set; }
