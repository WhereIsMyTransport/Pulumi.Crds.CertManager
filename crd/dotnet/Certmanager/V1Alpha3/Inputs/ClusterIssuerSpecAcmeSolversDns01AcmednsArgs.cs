...
namespace Pulumi.Kubernetes.Types.Inputs.Certmanager.V1Alpha3
{
    ...
    public class ClusterIssuerSpecAcmeSolversDns01AcmednsArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Certmanager.V1Alpha3.ClusterIssuerSpecAcmeSolversDns01AcmednsAccountSecretRefArgs> AccountSecretRef { get; set; } = null!;
