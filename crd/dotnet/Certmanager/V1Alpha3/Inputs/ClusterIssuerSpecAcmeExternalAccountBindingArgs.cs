...
namespace Pulumi.Kubernetes.Types.Inputs.Certmanager.V1Alpha3
{
    ...
    public class ClusterIssuerSpecAcmeExternalAccountBindingArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Certmanager.V1Alpha3.ClusterIssuerSpecAcmeExternalAccountBindingKeySecretRefArgs> KeySecretRef { get; set; } = null!;
